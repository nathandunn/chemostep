...
/*  *********************************************************************************** */
guialopexer::guialopexer(AppInterface* newApp)  : BaseFlatDriver(newApp)
{
}
...
//! Creates GUI and sets an instance of AlopexDriver as its application.
/*  *********************************************************************************** */
...
int main(int argc, char **argv)
{
    ...
    try{
        AlopexDriver* newApp = new AlopexDriver("APP","ANNEALER",NULL) ;
        guialopexer* driver = new guialopexer(newApp) ;
    ...
    if(mpi_myid==0){
        ...
        driver->setPrefName("guialopexer") ; 
