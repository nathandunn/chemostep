...
SeqResetBlitzNetAnnealer::SeqResetBlitzNetAnnealer() : SeqBlitzNetAnnealer()
{

}


AnnealingTarget* SeqResetBlitzNetAnnealer::anneal( ostream *toXML,string netOutputFile) 
{
...
void SeqResetBlitzNetAnnealer::dumpXmlAnnealStart(ostream* s) 
{
    *s << "<annealingrun>" <<endl ;
    *s << "\t<annealer type=\"seqresetblitznetannealer\">" << endl ; 
