...
/*  *********************************************************************************** */
plotapp::plotapp(AppInterface* newApp)  : BaseFlatDriver(newApp)
{
}
...
//! Creates GUI and sets an instance of PlotDriver as its application.
/*  *********************************************************************************** */
...
int main(int argc, char **argv)
{
    ...
    try{
        PlotDriver* newApp = new PlotDriver("APP","analysis",NULL) ;
        plotapp* driver = new plotapp(newApp) ;

	
        QApplication* qapp = new QApplication(argc,argv) ; 
        driver->setBaseAppName("analysis") ; 
        driver->setPrefName("plotapp") ; 
