...
/*  *********************************************************************************** */
analysisapp::analysisapp(AppInterface* newApp)  : BaseFlatDriver(newApp)
{
}
...
//! Creates GUI and sets an instance of AnalysisDriver as its application.
/*  *********************************************************************************** */
...
int main(int argc, char **argv)
{
    ...
    try{
        AnalysisDriver* newApp = new AnalysisDriver("APP","analysis",NULL) ;
        analysisapp* driver = new analysisapp(newApp) ;

	
        QApplication* qapp = new QApplication(argc,argv) ; 
        driver->setBaseAppName("analysis") ; 
        driver->setPrefName("analysisapp") ; 
