...
/*  *********************************************************************************** */
evoannealapp::evoannealapp(AppInterface* newApp)  : BaseFlatDriver(newApp)
{
}
...
int main(int argc, char **argv)
{
    ...
    try{
        EvoAnnealDriver* newApp = new EvoAnnealDriver("APP","ANNEALER",NULL) ;
        evoannealapp* driver = new evoannealapp(newApp) ;
    ...
    if(mpi_myid==0){
        ...
        driver->setPrefName("evoannealapp") ; 
